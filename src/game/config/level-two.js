export const LEVEL_TWO = {
  ...
  notes: [
    { x: 96, y: 120, text: 'Волна может перевозить друзей на голове. Мята: двойное I - лоза' },
    { x: 560, y: 372, text: 'Разгон с рампы. Дальше большая пропасть' },
    { x: 1130, y: 360, text: 'Двойное I - зацепиться/отцепиться. I/M - длина лозы. J/L - раскачка' },
